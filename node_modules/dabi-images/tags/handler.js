            ...
            switch (source) {
                case "reddit":
                    ...
                    function ExtractRedditUrl(body, tries) {
                        ...
                        switch ((/(\.jpg|\.png|\.gif|\.jpeg|\.gifv)$/ig).test(post.url) || post.url.includes(".com")) {
                            case true:
                    ...
                    if (filter == "top")
                    {
                        let options = ["hour", "day", "week", "month", "year", "all"], filter2 = options[Math.floor(Math.random() * options.length)];
                        url = `https://reddit.com/r/${site}/${filter}.json?t=${filter2}?limit=45`;
                    }
