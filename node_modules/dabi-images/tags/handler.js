        ...
        function(resolve, reject) {
            ...
            switch (source) {
                case "reddit":
                        ...
                        switch ((/(\.jpg|\.png|\.gif|\.jpeg|\.gifv)$/ig).test(post.url) || post.url.includes(".com")) {
                            case true:
                                ...
                                if(post.url.includes("gfycat.com"))
                                    post.url.replace("gfycat.com", "gifdeliverynetwork.com");
                    ...
                    let options = ["day", "week", "month", "year", "all"], filter = options[Math.floor(Math.random() *options.length)];
                    let url = `https://reddit.com/r/${site}/top.json?t=${filter}`;
