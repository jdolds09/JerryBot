...
client.on('message', async message => {
    ...
    if(message.channel.id != 774857738039459850)
    {
        ...
        else if(msg.includes("uhm"))
            message.channel.send("", {files: ['./images/uhm.png']});
        ...
        {
            if(msg.includes("kekleo"))
                message.channel.send("", {files: ['./images/kekleo.gif']});
        ...
        else if(msg.includes("widepeepohappy"))
            message.channel.send("", {files: ['./images/widepeepohappy.jpg']});
        ...
        else if(msg.includes("sadge"))
            message.channel.send("", {files: ['./images/sadge.png']});

        else if(msg.includes("modcheck"))
            message.channel.send("", {files: ['./images/modcheck.gif']});
        else
        {}
    ...
    else if(msg.includes("!schedule"))
    {
        ...
        {        
            ...
            var job = CronJob.schedule('0 54 10 * * *', function() {
                for(i = 0; i < 5; i++)
                {
                    // Fetch butts image
